    ...
    <div class="modal-dialog modal-lg">
       <div class="modal-content"> 
         <div class="modal-header">
            ...
            <h4 class="modal-title text-center" id="modal-title">Honda</h4>
          </div>
              ...
              <div class="row">
               <div class="col-sm-6">
                <div class="center-block">
                  <img src="Images/corolla-new.jpg" alt="Honda" class="details img-responsive" />
                 </div>
                </div>
                <div class="col-sm-6">
                  <h4>Details</h4> 
                  <p> this car is wonderful has good milages
                  </p> 
                  <hr/>
                  <p> Price: $600</p>
                  <p>Model: Fit</p>
