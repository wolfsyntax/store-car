...
<head>
  <title>Home | Manonamission</title>
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="site-wrap">
    ...
    <div class="hero-slide owl-carousel site-blocks-cover">
      <div class="intro-section" style="background-image: url('Images/usecar.jpg');">
        <div class="container">
          <div class="row align-items-center">
      ...
      <div class="intro-section" style="background-image: url('Images/car2.jpg');">
        <div class="container">
          <div class="row align-items-center">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="Images/banner1.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6">
            <span class="text-serif text-primary">About Us</span>
            <h3 class="heading-92913 text-black">Welcome To Our Website</h3>
            <p>Man on a mission motor is a userd car dealership who aims to please all its costomers With
